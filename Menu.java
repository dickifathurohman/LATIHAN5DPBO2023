...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2103842", "Dicki Fathurohman", "A", "FPMIPA"));
        listMhs.add(new Mahasiswa("2100143", "Park Jinyoung", "B", "FPSD"));
        listMhs.add(new Mahasiswa("2101243", "Jackson Wang", "C", "FPOK"));
    ...
    public final DefaultTableModel setTable() {
        // Column Title
        Object[] column = {"NIM", "NAMA", "NILAI", "FAKULTAS"};
        ...
        for (int i = 0; i < listMhs.size(); i++){
            ...
            row[3] = listMhs.get(i).getFakultas();
    ...
    public void insertData() {
        ...
        Object selecteditem = listFakultas.getSelectedItem();
        String fakultas = selecteditem.toString(); 
        
        
        // Add New Data
        listMhs.add(new Mahasiswa(nim, nama, nilai, fakultas));
        
        // Reset Form
        fieldNim.setText(null);
        fieldNama.setText(null);
        fieldNilai.setText(null);
        listFakultas.setSelectedIndex(0);
        ...
        JOptionPane.showMessageDialog(null, "Data has successfully added!");
    }
    ...
    public void deleteData() {
        ...
        // aksi ketika pengguna memilih tombol Yes
    ...
    private void initComponents() {
        ...
        listFakultas = new javax.swing.JComboBox<>();
        ...
        listFakultas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "FPMIPA", "FIP", "FPIPS", "FPTK", "FPBS", "FPSD", "FPEB", "FPOK" }));
        listFakultas.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                listFakultasItemStateChanged(evt);
            }
        });
        listFakultas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                listFakultasActionPerformed(evt);
            }
        });
        listFakultas.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                listFakultasPropertyChange(evt);
            }
        });

        lblNilai1.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblNilai1.setForeground(new java.awt.Color(255, 255, 255));
        lblNilai1.setText("Nilai");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(listFakultas, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(listFakultas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblNilai))
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        Object selectedFakultas = (tblMhs.getModel().getValueAt(row, 3).toString());
        ...
        listFakultas.setSelectedItem(selectedFakultas);
    ...
    private void listFakultasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listFakultasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_listFakultasActionPerformed

    private void listFakultasPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_listFakultasPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_listFakultasPropertyChange

    private void listFakultasItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_listFakultasItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_listFakultasItemStateChanged
    ...
    private javax.swing.JComboBox<String> listFakultas;
